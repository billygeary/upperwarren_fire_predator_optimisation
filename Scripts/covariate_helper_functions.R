...
balban = read_sf("~/Library/CloudStorage/Dropbox/Billy/_Research/_PhD/07_UpperWarren_WA/data/from Adrian Feb19/Spatial data/Baiting/Balban.shp")
camelar = read_sf("~/Library/CloudStorage/Dropbox/Billy/_Research/_PhD/07_UpperWarren_WA/data/from Adrian Feb19/Spatial data/Baiting/Camelar.shp")
keninup = read_sf("~/Library/CloudStorage/Dropbox/Billy/_Research/_PhD/07_UpperWarren_WA/data/from Adrian Feb19/Spatial data/Baiting/Keninup.shp")
kingston = read_sf("~/Library/CloudStorage/Dropbox/Billy/_Research/_PhD/07_UpperWarren_WA/data/from Adrian Feb19/Spatial data/Baiting/Kingston.shp")
perupcore = read_sf("~/Library/CloudStorage/Dropbox/Billy/_Research/_PhD/07_UpperWarren_WA/data/from Adrian Feb19/Spatial data/Baiting/Perup Core.shp")
perup_yendicup = read_sf("~/Library/CloudStorage/Dropbox/Billy/_Research/_PhD/07_UpperWarren_WA/data/from Adrian Feb19/Spatial data/Baiting/Perup_Yendicup_Baiting.shp")
...
den.muir = read_sf("~/Library/CloudStorage/Dropbox/Billy/_Research/_PhD/07_UpperWarren_WA/data/from Adrian Feb19/Predator data/BaitingData Request/baiting data from Marika 2021/Baiting History/Denbarker.Lake Muir 15.08.19.shp")
...
delandgraaft = read_sf("~/Library/CloudStorage/Dropbox/Billy/_Research/_PhD/07_UpperWarren_WA/data/from Adrian Feb19/Predator data/BaitingData Request/baiting data from Marika 2021/Baiting History/deLandgrafft.shp")
delandgraaft = delandgraaft %>% st_transform(bait.crs) %>% st_union() %>% st_buffer(dist=2500) %>% st_as_sf() 

# Add in Translocations
translocations = read_sf("~/Library/CloudStorage/Dropbox/Billy/_Research/_PhD/07_UpperWarren_WA/data/from Adrian Feb19/Predator data/BaitingData Request/baiting data from Marika 2021/Baiting History/Translocations.shp")
...
corbal_pf = read_sf("~/Library/CloudStorage/Dropbox/Billy/_Research/_PhD/07_UpperWarren_WA/data/from Adrian Feb19/Predator data/BaitingData Request/baiting data from Marika 2021/Baiting History/CorbalPostFireBaiting2021_22.shp")
corbal_pf = corbal_pf %>% st_set_crs(std.crs) %>% st_transform(bait.crs) %>% st_buffer(dist=2500) %>% st_as_sf() 

weinup_pf = read_sf("~/Library/CloudStorage/Dropbox/Billy/_Research/_PhD/07_UpperWarren_WA/data/from Adrian Feb19/Predator data/BaitingData Request/baiting data from Marika 2021/Baiting History/WeinupPostFireBaiting2021.shp")
weinup_pf =  weinup_pf %>% st_set_crs(std.crs) %>% st_transform(bait.crs) %>% st_buffer(dist=2500) %>% st_as_sf() 

# Add in FPC Baiting
coonan4 = read_sf("~/Library/CloudStorage/Dropbox/Billy/_Research/_PhD/07_UpperWarren_WA/data/from Adrian Feb19/Predator data/BaitingData Request/FPC/FPC_Coonan4Baiting.shp")
coonan4 =  coonan4 %>% st_transform(bait.crs) %>% st_buffer(dist=2500) %>% st_as_sf() 

coonan5 = read_sf("~/Library/CloudStorage/Dropbox/Billy/_Research/_PhD/07_UpperWarren_WA/data/from Adrian Feb19/Predator data/BaitingData Request/FPC/FPC_Coonan5Baiting.shp")
coonan5 =  coonan5 %>% st_transform(bait.crs) %>% st_buffer(dist=2500) %>% st_as_sf() 

yeticup = read_sf("~/Library/CloudStorage/Dropbox/Billy/_Research/_PhD/07_UpperWarren_WA/data/from Adrian Feb19/Predator data/BaitingData Request/FPC/FPC_YeticupBaiting.shp")
yeticup =  yeticup %>% st_transform(bait.crs) %>% st_buffer(dist=2500) %>% st_as_sf() 

# Last do Western Shield Aerial baiting for three cells
aerial = read_sf("~/Library/CloudStorage/Dropbox/Billy/_Research/_PhD/07_UpperWarren_WA/data/from Adrian Feb19/Spatial data/Baiting/WesternShield Flight Cells.shp")
...
baits = read.csv("~/Library/CloudStorage/Dropbox/Billy/_Research/_PhD/07_UpperWarren_WA/data/from Adrian Feb19/Predator data/predator.baiting.combined_BG_10052022.csv")
...
severity_raster = function(polyint,firehist, reference.date, lagyears){
  ...
  tlist <- data.frame(name = list.files("~/Library/CloudStorage/Dropbox/Billy/_research/_PhD/07_UpperWarren_WA/data/Upper Warren Fire Severity/CBI_maps", pattern = "tif"),
                      path = list.files("~/Library/CloudStorage/Dropbox/Billy/_research/_PhD/07_UpperWarren_WA/data/Upper Warren Fire Severity/CBI_maps", pattern = "tif", full=TRUE))
  tlist <- tlist %>% 
