...
# Read in raw data
eradicat = read.csv("~/Dropbox/Billy/_research/_PhD/07_UpperWarren_WA/data/from Adrian Feb19/Eradicat data/eradicat.camera.data.csv")
...
saveRDS(UpperWarrenMultiSpp, "Data_Processing/camtrapR.counthist.UpperWarren.multispp.22022022.RData")
